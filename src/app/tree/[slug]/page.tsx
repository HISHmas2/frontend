    ...
    <div className="relative h-[calc(100svh-56px)] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col px-4 pt-4 pb-[calc(12px+env(safe-area-inset-bottom))]">
        ...
        <div className="flex-1 min-h-0 flex items-center justify-center">
          <div ref={treeRef} onClick={placeDecoration} className="relative w-full max-w-[520px] aspect-[414/896]">
            <Image src="/images/Tree.png" alt="tree" fill priority className="object-contain pointer-events-none select-none scale-[1.15]" />
